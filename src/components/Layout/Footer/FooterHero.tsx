...
const FooterHero = () => {
  return (
        <Center color="white">
            <Flex 
                w='80%' direction={{base:'column',md:'row'}}
                px={{base:4, md:12}} py={{base:4, md:12}} 
                bgImage="linear-gradient(rgba(48, 0, 107, 0.9),rgba(129, 26, 255, 0.5)) , url('/images/image/groupBanner.png')"
                backgroundSize='cover'backgroundPosition='center center' zIndex='1' transform='auto' translateY={50}
            >
            <SimpleGrid textAlign={{base: "center", md: "start"}} px={{base: 0, md: 14}} columns={{base:1, sm: 1, md: 2}}>
                <VStack  w={{base:"full", md: "xl"}}>
                    <Heading as='h2' fontSize={{base:'3xl',md:'5xl'}} fontWeight='semibold' >
