...
const IncompleteVideoAnalytics = () => {
            ...
            {allVideoAnalytics && allVideoAnalytics.length > 0 ? (
                        ...
                        <Table borderRadius={'10px'}>
                            <Tbody>
                                ...
                                {allVideoAnalytics.map((data: any) => {
                                    if (data?.status_text === 'Completed') return;
                                    return (
                                        <>
                                            <Tr
                                                bg="lightWhite"
                ...
                <Grid
                    ...
                    <VStack spacing={6} px={{ base: 4, md: 8 }}>
                        ...
                        <Text mt="1rem">Videos with analysis in progress will appear here</Text>
                    </VStack>
                </Grid>
            )}
        </>
...
export default IncompleteVideoAnalytics;
