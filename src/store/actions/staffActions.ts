        ...
        CreateStaff(payload)
            .then((result) => {
                ...
                updateAlertMsg(toast, {
                    type: 'success',
                    message: 'Congratulations, Staff successfully created'
                });

                console.log('addStaffToClubPayload', addStaffToTeamData);
                AddStaffToTeam(addStaffToTeamData)
                    .then((newResult) => {
...
export const addSelectedStaffsToTeam = (
    payload: any[],
    team_id: string,
    club_id: string,
    toast: any,
    ...
    return async (dispatch: Dispatch) => {
        ...
        UpdateStaff(payload)
            .then((result) => {
                ...
                updateAlertMsg(toast, {
                    type: 'success',
                    message: 'Congratulations, Staff successfully updated'
                });
...
export const removeStaffFromTeam = (
    staff_id: string,
    role: string,
    team_id: string,
    club_id: any,
    ...
    return async (dispatch: Dispatch) => {
        ...
        RemoveStaffFromTeam(removeStaffFromClubPayload)
            .then((newResult) => {
                dispatch(addStaffToTeam(newResult?.data));
                updateAlertMsg(toast, {
                    type: 'success',
