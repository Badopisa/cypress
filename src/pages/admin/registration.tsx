        ...
        <SimpleGrid columns={1} rowGap={5} w='80%'>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <SimpleGrid mb={5} columns={2} spacing={3}>
              <GridItem>
                <FormControl isInvalid={errors.firstname}>
                  <FormLabel htmlFor='firstname'>Owner Firstname</FormLabel>
                  <Input
                    {...register('firstname', {
              ...
              <GridItem>
                <FormControl isInvalid={errors.lastname}>
                  <FormLabel htmlFor='lastname'>Owner Lastname</FormLabel>
                  <Input
                    {...register('lastname', {
            ...
            <FormControl mb={5} isInvalid={errors.phoneNumber}>
              <FormLabel htmlFor='phoneNumber'>Company Phone Number</FormLabel>
              {/* <Input
