...
import { Flex,FormControl, GridItem,Button, FormLabel, Input, FormErrorMessage,VStack, SimpleGrid, Select, Center, Text, InputGroup, InputRightElement, HStack, useToast, chakra} from '@chakra-ui/react'
   ...
   const onSubmit = async (values: any) => {
    ...
    <Flex h="auto" direction={{base:'column-reverse', md:'row'}} bg='primary'>
            <FormImage  image="/images/image/login-coach.jpg" title="GET STARTED AS" body="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut purus rhoncus lectus posuere elit et." hasRole role="A COACH"/>
                <VStack bgColor="black" color="white" w="full" h="full" py={10}  px={{base: 2, sm: 20}}  spacing={3} alignItems={{base: "center", md:"flex-start"}}>
                    <HStack spacing={6} >
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <SimpleGrid mb={4} columns={2} spacing={3}>
                            <GridItem>
                                <FormControl isInvalid={errors.s_date}>
                                    <FormLabel htmlFor="s_date">
                                        START DATE
                                    </FormLabel>
                                    <Input 
                                        {...register("s_date", {
                                            required: "Start Date is Required",
                                        })} id="s_date" placeholder="Enter your Start Date"
                                        type="date"
                                    />
                                    <FormErrorMessage>{errors.dob && errors.dob.message}</FormErrorMessage>
                                </FormControl>
                            ...
                            <GridItem >
                                <FormControl isInvalid={errors.e_date}>
                                    <FormLabel htmlFor="e_date">
                                        END DATE
                                    </FormLabel>
                                    <Input
                                         {...register("e_date", {
                                            required: "End date is required",
                                        })} id="e_date" type="date" placeholder="Enter your End Date"/>
                                    <FormErrorMessage>{errors.e_date && errors.e_date.message}</FormErrorMessage>
                                </FormControl>
                            </GridItem>
                        </SimpleGrid>
                        ...
                        <FormControl mb={4} isInvalid={errors.ePhoneNumber}>
                            <FormLabel htmlFor="ePhoneNumber">
                               EMMERGENCY PHONE NUMBER
                            </FormLabel>
                            <Input {...register("ePhoneNumber", {
                                    required: "Emmergency Phone number is required",
                                    minLength: { value: 4, message: "Emmergency Phone number is Required" }
                                })} id="ePhoneNumber" type="tel" placeholder="901-912-35646"/>
                            <FormErrorMessage>{errors.phoneNumber && errors.phoneNumber.message}</FormErrorMessage>
                        </FormControl>
                        <FormControl mb={4} isInvalid={errors.experience}>
                            ...
                            <Input  
                                ...
                                })} id="email"  type="number" placeholder="Enter your years of experience"/>
                        ...
                        <FormControl mb={4} isInvalid={errors.link}>
                            <FormLabel htmlFor="link">
                                LINK TO PORTFOLIO
                            </FormLabel>
                            <Input {...register("link")} id="link" type="tel" placeholder="Your Portfolio"/>
                            <FormErrorMessage>{errors.phoneNumber && errors.phoneNumber.message}</FormErrorMessage>
                        </FormControl>
                        <Button isLoading={isLoading} type="submit" variant="action" size="lg" w="full">CONTINUE</Button>
                    </form>    
                </SimpleGrid>
             </VStack>
        </Flex>  
