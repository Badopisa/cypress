            ...
            <Box color="white" mt={6} w={{base: '100%', md: "90%"}} p={{base: '4px'}}>
                ...
                <Flex direction={{base: "column-reverse", md: "row"}}>
                    <Tabs variant="unstyled" mt={{base: 8, md: 4}} alignContent="center" w={{base: '100%', md: "50%"}}>
                        ...
                        <TabList bg="dark" color="white" w={{base: '100%', md: "371px"}} rounded={5}
                    ...
                    <Flex direction="row" mt={6}>
                        <InputGroup w="279px">
                            ...
                            <Input type="tel" placeholder="Search for your team" value={searchText}
                        ...
                        filteredData?.length > 0 ?
                            <SimpleGrid
                                ...
                                {filteredData?.map((team, index) => (
                                    <PlayerCard image='/images/image/jersy.png' key={index} name={team.name}
                                                status="active" />
                                ))}
                            </SimpleGrid>
                            :
