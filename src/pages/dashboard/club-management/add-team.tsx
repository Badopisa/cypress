    ...
    return (
        <>
            ...
            <Box px={{base: 8, md: 8}} color="white">
                ...
                <Stack direction={{base: 'column', md: 'row'}} py={{base: 8, md: 8}} w="100%"
                       spacing={{base: 1, md: 4}}>
                    <Button
                        fontSize="xs"
                        variant="action"
                            ...
                            mb={8}>
                    {
                        currentTeam?.players === [] ? (
                            ...
                            currentTeam?.players?.map((player: any) => (
                                    <PlayerCard key={player.id} image='/images/image/jersy.png'
                                                name={`${player?.first_name} ${player?.last_name}`}
                                                status={'Pending Invite'} position={player?.position} />
                                )
                            )
                        )
                    }
