            ...
            <Flex h="100vh" direction={{base: 'column-reverse', md: 'row'}}>
                ...
                <VStack bgColor="black" color="white" w="full" h="full" p={{base: 2, sm: 20}} spacing={10}
                    ...
                    <VStack mt={10} spacing={1} alignItems={{base: "center", md: "flex-start"}}>
                        ...
                        <Text w={{base: "90%"}} align={{base: "center", md: "start"}}>Welcome back and get to see what
                                                                                      has been happening since you’ve
                                                                                      been gone</Text>
                    </VStack>
                    <SimpleGrid columns={1} rowGap={5} w="80%">
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <Button isLoading={isLoading} type="submit" variant="action" size="lg"
                                    w="full">LOGIN</Button>
                        </form>
                        <Text align={'center'}>
