        ...
        <GuestWrapper>
            <Box w="full" bg="black">
                        ...
                        <VStack spacing={4} align="left" justifyContent="center">
                            ...
                            <Flex w={{ base: '100%', md: '90%' }}>
                                <Text>
                                    ...
                                    application user friendly and easily accessible. Creating a web
                                    application that can collate analytical data from a soccer match
                ...
                <Flex mt={{ base: 10, md: 0 }} bg="black" color="white">
                    <Flex
                        backgroundImage="/images/image/hero-bg.jpg"
                        w="full"
                        h={{ base: '80%', md: '80vh' }}
                        px={{ base: 4, md: 32 }}
                        py={{ base: 4, md: 24 }}>
                        <SimpleGrid columns={{ base: 1, md: 3 }} w="full" spacing={20}>
                            <FeatureCard
                                image="/images/image/coach.jpg"
                                heading="A COACH"
                                title="GET STARTED AS"
                            />
                            <FeatureCard
                                image="/images/image/player.jpg"
                                heading="A PLAYER"
                                title="GET STARTED AS"
                            />
                            <FeatureCard
                                image="/images/image/analyst.jpg"
                                heading="CLUB ADMIN"
                                title="GET STARTED AS"
                            />
                        </SimpleGrid>
                ...
                <VStack
                    ...
                    <VStack px={{ base: 4, md: 24 }} w="full" align="left">
                        <Text color={'muted'} fontSize="lg" fontWeight="normal">
                            FEATURES
                        </Text>
                    ...
                    <SimpleGrid columns={{ base: 1, md: 3 }} spacing={8}>
                        <OfferCard
                            ...
                            subTitle="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Tortor, nullam id aliquam."
                        />
                        <OfferCard
                            image="images/image/recruitment.svg"
                            title="Recruitment"
                            subTitle="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Tortor, nullam id aliquam."
                        />
                        <OfferCard
